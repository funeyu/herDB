...
//    },
    ...
    LONG {
        ...
        @Override Long deserialize(byte[] bytes, int off, int len) {
            ByteBuffer byteBuffer = ByteBuffer.wrap(bytes, off, len);
    ...
    SHORT {
        ...
        @Override Short deserialize(byte[] bytes, int off, int len) {
            ByteBuffer byteBuffer = ByteBuffer.wrap(bytes, off, len);
    ...
    BOOLEAN {
        ...
        @Override Boolean deserialize(byte[] bytes, int off, int len) {
            ByteBuffer byteBuffer = ByteBuffer.wrap(bytes, off, len);
    ...
    FLOAT {
        ...
        @Override Float deserialize(byte[] bytes, int off, int len) {
            ByteBuffer byteBuffer = ByteBuffer.wrap(bytes, off, len);

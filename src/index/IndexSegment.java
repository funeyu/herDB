...
public class IndexSegment extends ReentrantLock{
	...
	public IndexSegment(int compacity, String fileName, int current, byte[]bytes, 
			InputOutData fs, InputOutData fsData){
	...
	public final  static IndexSegment createIndex(FSDirectory fs, String fileName) 
			throws Exception{
	...
	public void put(byte[]key, int hashcode, byte[]value) 
			throws IOException{
	...
	/**
	 * 索引文件达到full即attachedSlots没有可以再利用
	 * 需要扩容
	 */
	private void resize(){
